...
- Number of walls given from cutting the long extra piece (The rightmost rectangle on the maze cutout picture): 5\*(8 ft/(18 cm - 2*(0.5\*post width + connector width)) = 5\*(8 ft/(18 cm - 2\*(0.5\*0.25 in + 0.05 in)) = 70 (enough for now)
